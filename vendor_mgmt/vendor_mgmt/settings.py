...
#   from decouple import config '''decouple not working properly'''
import os
from dotenv import load_dotenv

load_dotenv(dotenv_path=Path('/home/nithinsaikrishna/Desktop/Projects/vendor_management/vendor_mgmt/.djangoenv'))
